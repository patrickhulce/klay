...
function extractErrorMessage(error) {
  if (typeof error.toErrorObject === 'function') {
...
ValidationResult.prototype.asError = function () {
  return this.conforms ? null : new ValidationError(this)
}

ValidationResult.coalesce = function (validationResults, base) {
  return validationResults.reduce((cumulative, result) => {
