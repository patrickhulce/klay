...
function Model(spec) {
  ...
  _.forEach(assignments, function assignPropertyInConstructor(value, name) {
...
Model.prototype.children = function (children) {
  ...
  if (_.isArray(children)) {
    ...
    return this._with({children: children})._callHooks('children');
  } else if (this.spec.type === 'array') {
    ...
    function kvToChild(v, k) {
      try {
        ...
        throw new Error(`failed to create child model for property "${k}": ${e.message}`);
      }
    }
