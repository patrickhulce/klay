...
defineTest('helpers/validateAndAutomanage.js', function (validateAndAutomanageFactory) {
  ...
  context('when event is create', function () {
    ...
    it('should validate the object', function () {
      var results = validateAndAutomanage({age: '17'});
    ...
    it('should transform the object', function () {
      var results = validateAndAutomanage({name: 'John', age: '22'});
      results.should.have.property('conforms', true);
      results.should.have.deep.property('value.age', 22);
    });

    it('should create the pre-validate automanaged properties', function () {
      var results = validateAndAutomanage({name: 'Jack', age: '63'});
    ...
    it('should create the post-validate automanaged properties', function () {
      var results = validateAndAutomanage({name: 'Jill', age: '17'});
    ...
    it('should fail loudly when options dictate', function () {
      (function () {
  ...
  context('when event is update', function () {
    var validateAndAutomanage, base;
    ...
    it('should transform the object', function () {
      var results = validateAndAutomanage({
        id: '12',
        name: 'John',
        age: '22',
    ...
    it('should create the pre-validate automanaged properties', function () {
      var results = validateAndAutomanage(_.assign({name: 'Jack', age: '63'}, base));
      results.value.should.have.property('changed', true);
      results.value.should.have.property('updatedAt').instanceof(Date);
    });

    it('should create the post-validate automanaged properties', function () {
      var results = validateAndAutomanage(_.assign({name: 'Jennie', age: '20'}, base));
